<?php
    ...
    $pageSize = $_POST [ 'pdfPaperSize' ]; //paper size
    ...
    function setConfigure() {        
        global $paiweiTable, $pageSize, $pdf, $ChineseFont, $EnglishFont;
        ...
        switch ($paiweiTable) {
            ...
            case 'D001A':
                ...
                if ( $pageSize == 'LETTER' ) {
                    // LETTER paper size settings
                    $topMargin=0.7; $leftMargin=0.1; $rightMargin=0.1; $pdfTitle='地基主蓮位';
                    $imgPath='img/XiaoPaiWei.png'; $imgWidth=2.3; $imgHeight=7.5; $imgType='PNG';
                    $paiweiNumPerPage=5; $prefixPaiwei='佛力超薦'; $suffixPaiwei='往生蓮位'; $commonStrPaiwei='地基主'; $suffixReq='敬薦';
                    $fontSizePaiwei=18; $fontSizePrefixPaiwei=20; $fontSizeReq=14; $fontSizePrefixReq=16; $fontSizeAddress=12;
                    $fontStylePaiwei='B'; $fontStyleReq='B'; $fontStyleAddress='';
                    $rotateXadjustPaiwei=1.05*$pdf->GetStringWidth('G', $EnglishFont, $fontStylePaiwei, $fontSizePaiwei, false);
                    $textXadjustPaiwei=2.2*$pdf->GetStringWidth('G', $EnglishFont, $fontStylePaiwei, $fontSizePaiwei, false);
                    ...
                    $rotateXadjustAddress=1.2*$pdf->GetStringWidth('G', $EnglishFont, $fontStyleAddress, $fontSizeAddress, false);
                    $textXadjustAddress=2.3*$pdf->GetStringWidth('G', $EnglishFont, $fontStyleAddress, $fontSizeAddress, false);
                    $xIniPaiwei=9.77; $xStepPaiwei=2.15; $yPrefixPaiwei=2.0; $ySuffixPaiwei=5.5; $yPaiweiCommon=3.95;
                    $xIniReq=8.885; $xStepReq=2.15; $yPrefixReq=3.2; $ySuffixReq=6.0; $yTopReq=3.75; $yBottomReq=5.95;
                    $xIniAddress=10.23; $xStepAddress=2.15; $yTopAddress=2.05; $yBottomAddress=6.35;
                    $mulLineXadjustPaiwei=0.13; $mulLineXadjustReq=0.1; $mulLineXadjustAddress=0.08;                    
                }                
                break;
            case 'L001A':
                ...
                if ( $pageSize == 'LETTER' ) {
                    // LETTER paper size settings
                    $topMargin=0.7; $leftMargin=0.1; $rightMargin=0.1; $pdfTitle='歷代祖先蓮位';
                    $imgPath='img/XiaoPaiWei.png'; $imgWidth=2.3; $imgHeight=7.5; $imgType='PNG';
                    $paiweiNumPerPage=5;
                    $prefixPaiwei='佛力超薦'; $suffixPaiwei='往生蓮位'; $commonStrPaiwei='氏歷代祖先'; $suffixReq='叩薦';
                    $fontSizePaiwei=18; $fontSizePrefixPaiwei=20; $fontSizeReq=14; $fontSizePrefixReq=16;
                    ...
                    $rotateXadjustReq=1.1*$pdf->GetStringWidth('G', $EnglishFont, $fontStyleReq, $fontSizeReq, false);
                    $textXadjustReq=2.2*$pdf->GetStringWidth('G', $EnglishFont, $fontStyleReq, $fontSizeReq, false);
                    $xIniPaiwei=9.77; $xStepPaiwei=2.15; $yPrefixPaiwei=2.0; $ySuffixPaiwei=5.5; $yTopPaiwei=3.2; $yBottomPaiwei=5.45; $yPaiweiCommon=3.85;    
                    $xIniReq=8.885; $xStepReq=2.15; $yPrefixReq=3.2; $ySuffixReq=6.0; $yTopReq=3.75; $yBottomReq=5.95;
                    $mulLineXadjustPaiwei=0.13; $mulLineXadjustReq=0.1;                    
                }                
                break;
            case 'Y001A':
                ...
                if ( $pageSize == 'LETTER' ) {
                    // LETTER paper size settings
                    $topMargin=0.7; $leftMargin=0.1; $rightMargin=0.1; $pdfTitle='累劫冤親債主蓮位'; 
                    $imgPath='img/XiaoPaiWei.png'; $imgWidth=2.3; $imgHeight=7.5; $imgType='PNG';
                    $paiweiNumPerPage=5;
                    $prefixPaiwei='佛力超薦'; $suffixPaiwei='往生蓮位'; $commonStrPaiwei='累劫冤親債主'; $suffixReq='敬薦';
                    $fontSizePaiwei=18; $fontSizePrefixPaiwei=20; $fontSizeReq=14; $fontSizePrefixReq=16;
                    ...
                    $rotateXadjustReq=1.1*$pdf->GetStringWidth('G', $EnglishFont, $fontStyleReq, $fontSizeReq, false);
                    $textXadjustReq=2.2*$pdf->GetStringWidth('G', $EnglishFont, $fontStyleReq, $fontSizeReq, false);
                    $xIniPaiwei=9.77; $xStepPaiwei=2.15; $yPrefixPaiwei=2.0; $ySuffixPaiwei=5.5; $yPaiweiCommon=3.575;
                    $xIniReq=8.885; $xStepReq=2.15; $yPrefixReq=3.2; $ySuffixReq=6.0; $yTopReq=3.75; $yBottomReq=5.95;
                    $mulLineXadjustReq=0.1;
                }                
                break;
            case 'W001A_4':
                ...
                if ( $pageSize == 'LETTER' ) {
                    // LETTER paper size settings
                    $topMargin=0.7; $leftMargin=0.1; $rightMargin=0.1; $pdfTitle='往生者蓮位';
                    $imgPath='img/XiaoPaiWei.png'; $imgWidth=2.3; $imgHeight=7.5; $imgType='PNG';
                    $paiweiNumPerPage=5; $prefixPaiwei='佛力超薦'; $suffixPaiwei='往生蓮位'; $suffixReq=' 薦';
                    $fontSizePaiwei=18; $fontSizePrefixPaiwei=20; $fontSizeReq=14; $fontSizePrefixReq=16;
                    $fontStylePaiwei='B'; $fontStyleReq='B';
                    $rotateXadjustPaiwei=1.05*$pdf->GetStringWidth('G', $EnglishFont, $fontStylePaiwei, $fontSizePaiwei, false);
                    $textXadjustPaiwei=2.2*$pdf->GetStringWidth('G', $EnglishFont, $fontStylePaiwei, $fontSizePaiwei, false);
